...
<body bgcolor="#FFFFFF">
        ...
        <form action="http://ec2-54-215-197-27.us-west-1.compute.amazonaws.com/phpMyAdmin/htdocs/modules/EventUp/templates/UserProfile_Admin.php" method="post">
        <div>
        <h2 class="sub-head">Smart Node for EventUp</h2>
        <div class="sub-main">  
