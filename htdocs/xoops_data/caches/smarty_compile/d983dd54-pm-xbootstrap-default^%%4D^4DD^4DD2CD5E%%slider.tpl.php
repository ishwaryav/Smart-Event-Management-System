<?php /* Smarty version 2.6.25-dev, created on 2017-11-08 20:17:39
         compiled from xbootstrap/tpl/slider.tpl */ ?>
...
<div id="myCarousel" class="carousel slide slideshow" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active"><img alt="XOOPS" src="<?php echo $this->_tpl_vars['xoops_imageurl']; ?>
images/slider1.jpg">
            ...
            <div class="carousel-caption hidden-xs">
                ...
                <p><a href="javascript:;" class="btn btn-large btn-primary"><?php echo @THEME_READMORE; ?>
</a></p>
            </div>
        </div>
        <div class="item"><img alt="XOOPS" src="<?php echo $this->_tpl_vars['xoops_imageurl']; ?>
images/slider2.jpg">
