<?php /* Smarty version 2.6.25-dev, created on 2017-11-08 20:21:13
...
echo 'http://localhost/htdocs/modules/system/images/icons/default/view_large.png'; ?>"
...
echo 'http://localhost/htdocs/modules/system/images/icons/default/view_small.png'; ?>"
...
">
                <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/install.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_TOINSTALL; ?>
"/>
...
echo 'http://localhost/htdocs/modules/system/images/icons/default/applications.png'; ?>" alt="<?php echo $this->_tpl_vars['row']['name']; ?>
" title="<?php echo $this->_tpl_vars['row']['name']; ?>
"/>
                                </a>
...
">
                                    <?php if ($this->_tpl_vars['row']['warning_update'] == 1): ?>
                                        <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/messagebox_warning.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_UPDATE; ?>
"/>
                                    <?php else: ?>
                                        <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/reload.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_UPDATE; ?>
"/>
                                    <?php endif; ?>
                                </a>
                            <?php endif; ?>
...
, true, true, 'slide', 'slide', 240, 450);"
                                 src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/info.png'; ?>" alt="<?php echo @_INFO; ?>
...
">
                                <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/uninstall.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_UNINSTALL; ?>
"/>
                            </a>
                            <img class="cursorpointer tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['row']['mid']; ?>
, true, true, 'slide', 'slide', 240, 450);"
...
">
                        <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/install.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_INSTALL; ?>
"/>
                    </a>
                    <img class="cursorpointer tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['row']['mid']; ?>
, true, true, 'slide', 'slide', 240, 450);"
