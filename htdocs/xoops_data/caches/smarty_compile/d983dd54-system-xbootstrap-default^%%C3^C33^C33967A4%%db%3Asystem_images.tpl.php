<?php /* Smarty version 2.6.25-dev, created on 2017-11-08 20:30:51
         compiled from db:system_images.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:system_images.tpl', 38, false),)), $this); ?>
<!-- Header -->
    ...
    <div class="xo-buttons">
        <?php if (! $this->_tpl_vars['edit_form'] && ! $this->_tpl_vars['listimg']): ?>
            <button id="xo-addcat-btn" class="ui-corner-all tooltip" onclick="xo_toggle('div#xo-category-add');"
                    title="<?php echo @_AM_SYSTEM_IMAGES_ADDCAT; ?>
">
                <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_ADDCAT; ?>
"/>
        ...
        <?php if ($this->_tpl_vars['cat_img'] || $this->_tpl_vars['listimg']): ?>
            <button id="xo-addimg-btn" class="ui-corner-all tooltip" onclick="xo_toggle('div#xo-images-add');"
                    title="<?php echo @_AM_SYSTEM_IMAGES_ADDIMG; ?>
">
                <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_ADDIMG; ?>
"/>
...
', 'admin.php' )"
                                                                                             src="<?php if ($this->_tpl_vars['cat']['display']): ?><?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/success.png'; ?><?php else: ?><?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>"
                                                                                             alt=""
                                                                                             title="<?php if ($this->_tpl_vars['cat']['display']): ?><?php echo @_AM_SYSTEM_IMAGES_OFF; ?>
...
">
                        <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/display.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_VIEW; ?>
"/>
                    </a>
...
">
                            <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_EDIT; ?>
"/>
                        </a>
...
">
                            <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/delete.png'; ?>" alt=""/>
                        </a>
                    <?php endif; ?>
                </td>
            </tr>
...
', 'admin.php' )"
                                                                              src="<?php if ($this->_tpl_vars['img']['image_display']): ?><?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/success.png'; ?><?php else: ?><?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>"
...
">
                                <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_DELETE; ?>
"/>
                            </a>
                            <img class="tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['img']['image_id']; ?>
, true, true, 'slide', 'slide', 120, 350);"
                                 src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/url.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_URL; ?>
"
...
<script type="text/javascript">
    IMG_ON = '<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/success.png'; ?>';
    IMG_OFF = '<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/cancel.png'; ?>';
