<?php /* Smarty version 2.6.25-dev, created on 2017-11-08 20:30:58
         compiled from db:system_comments.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:system_comments.tpl', 34, false),)), $this); ?>
    ...
    <div class="floatright">
        <div class="xo-buttons">
            <button class="ui-corner-all" onclick="self.location.href='admin.php?fct=comments&op=comments_form_purge'">
                <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/clear.png'; ?>" alt="<?php echo @_AM_SYSTEM_COMMENTS_FORM_PURGE; ?>
"/>
...
', true, true, 'slide', 'slide', 300, 500);"
                             src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/display.png'; ?>" alt="<?php echo @_AM_SYSTEM_COMMENTS_VIEW; ?>
"
...
' style='display:none;'>
            <img src="<?php 
echo 'http://localhost/htdocs/modules/system/images/icons/default/comment.png'; ?>" alt="comments" title="comments" class="xo-commentsimg"/>
