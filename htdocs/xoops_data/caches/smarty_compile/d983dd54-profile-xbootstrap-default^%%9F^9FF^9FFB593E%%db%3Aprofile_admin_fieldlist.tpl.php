<?php /* Smarty version 2.6.25-dev, created on 2017-11-08 20:22:00
...
"><img
                                        src="<?php 
echo 'http://localhost/htdocs/Frameworks/moduleclasses/icons/16/'; ?><?php echo $this->_tpl_vars['field']['field_required']; ?>
...
"><img src="<?php 
echo 'http://localhost/htdocs/Frameworks/moduleclasses/icons/16/edit.png'; ?>"
                                                                                                            alt="<?php echo @_EDIT; ?>
"
                                                                                                            title="<?php echo @_EDIT; ?>
"/></a>
...
"><img
                                        src="<?php 
echo 'http://localhost/htdocs/Frameworks/moduleclasses/icons/16/delete.png'; ?>" alt="<?php echo @_DELETE; ?>
" title="<?php echo @_DELETE; ?>
"</a>
                        <?php endif; ?>
                    </td>
