...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="/htdocs/modules/People/index.php" class="w3-bar-item w3-button "><i class="fa fa-home w3-margin-right"></i>Home</a>
  ...
  <script type="text/javascript">
    ...
    .div2{
      ...
      margin-right: 100px;
        ...
        <div class="w3-container div2" id="chart_div" style="width: 755px; height: 400px;"></div>
        <div class="w3-container div2" id="chart_div1" style="width: 755px; height: 400px;"></div>
        <div class="w3-container div2" id="chart_div2" style="width: 755px; height: 400px;"></div>
        <div class="w3-container div2" id="columnchart_values" style="width: 755px; height: 400px;"></div>
