<?php /* Smarty version 2.6.25-dev, created on 2017-11-08 20:21:13
         compiled from /Applications/XAMPP/xamppfiles/htdocs/htdocs/modules/system/language/english/help/modulesadmin.html */ ?>
<div id="help-template" class="outer">
    ...
    <p class="even">
        ...
        check icon in the Menu column. So for the News module, you could then send a private messages to selected group of your users and tell them to access that directory typing the address in the URL field, something like <em>http://www.yoursite.com/modules/news</em>. <br/><br/>
        ...
        address (in this example 'news') shows the module that will display contents of that menu link. <br/><br/>
