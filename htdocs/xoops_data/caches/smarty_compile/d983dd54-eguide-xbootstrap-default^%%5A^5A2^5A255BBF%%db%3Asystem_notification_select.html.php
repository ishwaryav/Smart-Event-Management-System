...
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'db:system_notification_select.html', 23, false),)), $this); ?>
...
" method="post">
        <h4 class="txtcenter"><?php echo $this->_tpl_vars['lang_activenotifications']; ?>
</h4>
...
"/>
        ...
        <table class="outer">
            <tr>
                <th colspan="3"><?php echo $this->_tpl_vars['lang_notificationoptions']; ?>
</th>
            </tr>
            <tr>
                ...
                <td class="head"><input name="allbox" id="allbox" onclick="xoopsCheckAll('notification_select','allbox');" type="checkbox"
                                        value="<?php echo $this->_tpl_vars['lang_checkall']; ?>
"/></td>
...
"/>
            ...
            <?php endforeach; endif; unset($_from); ?>
            <tr>
                <td class="foot txtcenter" colspan="3"><input type="submit" name="not_submit" value="<?php echo $this->_tpl_vars['lang_updatenow']; ?>
"/></td>
            </tr>
        </table>
        <div class="txtcenter">
